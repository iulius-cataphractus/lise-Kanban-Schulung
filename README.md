...
Das Format entstand aus einer internen Schulungsserie und ist so aufgebaut, dass es von ausgebildeten Facilitatoren eigenständig durchgeführt werden kann – remote, on-site oder hybrid.
...
**Geeignet für:**
- Teams, die Kanban einführen oder vertiefen wollen
- Agile Coaches, die ein reproduzierbares Schulungsformat suchen
- Organisationen, die Kanban intern skalieren möchten
...
Entwickelt von Julian Panze, lise GmbH.
Fragen, Fehler, Verbesserungsvorschläge: Issue öffnen oder Pull Request einreichen.

[lise.de](https://lise.de) · julian.panze@lise.de